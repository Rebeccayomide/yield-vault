...
(contract-call? .yieldvault get-user-vault-value u1 'SP123...)

;; Get platform statistics
(contract-call? .yieldvault get-platform-stats)

;; Find best available APY
(contract-call? .yieldvault get-best-apy)
```
...
(contract-call? .yieldvault get-vault-info u1)

;; Get user's position in vault
(contract-call? .yieldvault get-user-position u1 'SP123...)

;; List all user's vaults
(contract-call? .yieldvault get-user-vaults 'SP123...)
```
